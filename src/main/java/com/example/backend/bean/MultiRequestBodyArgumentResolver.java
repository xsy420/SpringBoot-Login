...
/**
 * https://cloud.tencent.com/developer/article/1870118
 * */
public class MultiRequestBodyArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter,
                                  ...
                                  @SuppressWarnings("NullableProblems") NativeWebRequest webRequest,
    ...
    private boolean isBasicDataTypes(Class<?> clazz) {
        return Set.of(Integer.class, Long.class, Short.class,
                Float.class, Double.class, Boolean.class,
                Byte.class, Character.class).contains(clazz);
    }
